    ...
    <div class="auth-box">
      ...
      <form @submit.prevent="handleSignup">
        ...
        <div class="field">
          ...
          <input v-model="form.nickname" type="text" placeholder="닉네임 입력" required />
        </div>
        <div class="field">
      ...
      <p class="link">이미 계정이 있으신가요? <RouterLink to="/login">로그인</RouterLink></p>
    </div>
  </div>
</template>
...
const form = reactive({ email: '', password: '', nickname: '', region: '' })
const error = ref('')
